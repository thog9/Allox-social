...
░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░░╚═════╝░░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝╚═╝░░╚═╝░╚═════╝░╚═════╝░
    ...
    print_border("ALLOX SOCIAL", Fore.GREEN)
...
async def run_socialX(language: str):
    from scripts.socialX import run_socialX
    await run_socialX(language)
...
async def run_bonus(language: str):
    from scripts.bonus import run_bonus
    await run_bonus(language)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            ...
            {"name": "2. Welcome Bonus (Season 1)", "value": "bonus"},
            {"name": "3. K\u1ebft n\u1ed1i Twitter (X OAuth)", "value": "connect"},
            {"name": "4. Auto Twitter Tasks", "value": "socialX"},
